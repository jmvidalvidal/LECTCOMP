...
Ext.define('LECTCOMP.view.inicialView', {
    ...
    onBotoEnviarTap1: function(button, e, options) {
        this.push({type:'panellCarregar'});
    },

    onBotoLecturesTap: function(button, e, options) {
    	//debugger;
        //var panellLect = Ext.create('LECTCOMP.view.panellLectures',{fullscreen: true});
